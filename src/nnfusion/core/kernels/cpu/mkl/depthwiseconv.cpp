...
cpu::DepthConvolutionMkl::DepthConvolutionMkl(shared_ptr<KernelContext> ctx)
...
LanguageUnit_p cpu::DepthConvolutionMkl::emit_function_body()
{
...
LanguageUnit_p cpu::DepthConvolutionMkl::emit_dependency()
{
...
REGISTER_KERNEL_EMITTER(
    ...
    cpu::DepthConvolutionMkl)                                                     // constructor
