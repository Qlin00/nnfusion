...
from sparta.common.utils import generate_block_sparse_cfg, inject_kernel, inject_kernel_with_id
import argparse
import os
import json
import torch
...
if __name__ == '__main__':
    ...
    inject_kernel_with_id(template_path, kernel_path, 'BalanceDot', id_map_path, os.path.join(args.out_dir, 'kernel'))