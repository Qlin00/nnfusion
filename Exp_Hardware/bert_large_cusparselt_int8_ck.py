...
from sparta.common.utils import export_tesa, export_tesa_debug, generate_cusparselt_int8_sparse_cfg
...
out_dir = f'cusparselt_int8_bert_large_n_{remain_n}_m_{total_m}_align{align}'
...
generate_cusparselt_int8_sparse_cfg(tesa_path, state_path, id_map_path, out_dir)
