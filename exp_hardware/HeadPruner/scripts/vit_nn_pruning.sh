...
sudo TOKENIZERS_PARALLELISM=false CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 /opt/miniconda/bin/python -m torch.distributed.launch --nproc_per_node=8 ViT_nn_pruner.py \
