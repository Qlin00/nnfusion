...
# @Last Modified time: 2022-06-22 20:26:13
...
if __name__ == "__main__":
    ...
    if training_args.local_rank in [0, -1]:
        ...
        joblib.dump(
            ...
            f"results/{pruning_args.final_threshold:.3f}_{pruning_args.block_size_row}_{pruning_args.block_size_col}_{training_args.seed}.pkl",
        )
