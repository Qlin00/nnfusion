...
if __name__ == '__main__':
    ...
    parser.add_argument('--blockh', type=int, default=1)
    parser.add_argument('--blockw', type=int, default=1)
    ...
    # import ipdb; ipdb.set_trace()
    data_dir = f"bert_{task_name}_{sparsity}_uniform_block_{args.blockh}_{args.blockw}"
